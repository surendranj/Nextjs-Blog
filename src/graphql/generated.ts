...
export type PostManyWhereInput = {
  ...
  /** All values containing the given string. */
  postImage_contains?: InputMaybe<Scalars['String']>;
  /** All values ending with the given string. */
  postImage_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are contained in given list. */
  postImage_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values that are not equal to given value. */
  postImage_not?: InputMaybe<Scalars['String']>;
  /** All values not containing the given string. */
  postImage_not_contains?: InputMaybe<Scalars['String']>;
  /** All values not ending with the given string */
  postImage_not_ends_with?: InputMaybe<Scalars['String']>;
  /** All values that are not contained in given list. */
  postImage_not_in?: InputMaybe<Array<Scalars['String']>>;
  /** All values not starting with the given string. */
...
export const useGetAuthorQuery = <
    ...
    useQuery<GetAuthorQuery, TError, TData>(
      ['GetAuthor', variables],
      fetcher<GetAuthorQuery, GetAuthorQueryVariables>(client, GetAuthorDocument, variables, headers),
      options
    );
...
export const useCreateAuthorMutation = <
    ...
    useMutation<CreateAuthorMutation, TError, CreateAuthorMutationVariables, TContext>(
      ['CreateAuthor'],
      (variables?: CreateAuthorMutationVariables) => fetcher<CreateAuthorMutation, CreateAuthorMutationVariables>(client, CreateAuthorDocument, variables, headers)(),
      options
    );
export const UpsertAuthorDocument = `
  ...
  author: upsertAuthor(where: $where, upsert: $upsert) {
    ...
    `;
export const useUpsertAuthorMutation = <
      TError = unknown,
      TContext = unknown
    >(
      client: GraphQLClient,
      options?: UseMutationOptions<UpsertAuthorMutation, TError, UpsertAuthorMutationVariables, TContext>,
      headers?: RequestInit['headers']
    ) =>
    useMutation<UpsertAuthorMutation, TError, UpsertAuthorMutationVariables, TContext>(
      ['UpsertAuthor'],
      (variables?: UpsertAuthorMutationVariables) => fetcher<UpsertAuthorMutation, UpsertAuthorMutationVariables>(client, UpsertAuthorDocument, variables, headers)(),
      options
    );
